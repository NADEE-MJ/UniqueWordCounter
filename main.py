...
def main():
    ...
    The following example uses the passage Romeo and Juliet, prints the number of unique words and 10 top ten occurances to the console and outputfile and saves the entire formatted text and list of unique words and the number of times they each occur 
    """
